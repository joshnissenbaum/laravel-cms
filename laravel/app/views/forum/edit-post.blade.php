...
@section('content')
   <div class="create-thread">
    <div class="row">
        <div class="col-md-9">
            {{ Form::model($post, array('action' => 'ForumController@editPost', 'id' => 'editpost', 'files' => 'true')) }}
        <a href="{{ URL::route('forumpost', ['id' => $post->thread_id])}}">    
            <div class="grey-bg-hdr" style="padding: 0; padding-left: 10px; padding-right: 3px;">
                <div class="main-header">
                    <h1>{{ $post->thread->title }} &middot;&nbsp;</h1>
                </div>
            </div>
        </a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
         <a href="{{ URL::route('forum.deletepost', array('id' => $post->id)) }}"><button type="button" class="btn btn-primary">Delete</button></a>
